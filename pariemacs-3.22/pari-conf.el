...
(defconst gp-version "2-15-3" "pari's version number")

(defconst gp-file-name "gp"
 "The file name of the gp executable file")

(defconst gp-gphelp-dir "\"C:\\Program Files (x86)\\Pari64-2-15-3\\\""
  "The directory where gphelp is to be found")

(defconst gp-pariemacs "\"C:\\Program Files\\Emacs\\emacs-28.2\\share\\emacs\\site-lisp\_pariemacs-3.22\\README\""
  "The pariemacs file")
